...
if $connected; then
    ...
    > "$scriptsFolder/ytdl/util/vidsurlsmusic.txt"
    ...
    do
        ...
        jq -r '.id' | \
        sed 's_^_https://youtube.com/v/_' >> "$scriptsFolder/ytdl/util/vidsurlsmusic.txt"
    done < "$scriptsFolder/ytdl/channel_lists/MusicChannels.txt"
