...
sortedSize=0; toSortSize=0; filesToSort=0; spToSort=0; fProjects=0; aProjects=0; finTasks=0; finNRTasks=0; NRTasks=0; SNRTasks=0; ActTasks=0; sortedMusic=0; toSortMusic=0
...
read -p "Voulez-vous les métriques de Marvin ? (y/n) " answer
...
read -p "Voulez-vous les métriques des fichiers ? (y/n) " answer
